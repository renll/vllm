...
class SambaMambaMixer(nn.Module):
    """
...
class SambaMambaDecoderLayer(nn.Module):
    ...
    def __init__(self,
        ...
        super().__init__()
        self.config = config
        self.attn = SambaMambaMixer(config)
    ...
    def forward(
        ...
        **kwargs,
        ...
        hidden_states = self.attn(hidden_states, attn_metadata,
                                   mamba_cache_params)
        # Fully Connected
...
ALL_DECODER_LAYER_TYPES = {
    "attention": SambaAttentionDecoderLayer,
    "mamba": SambaMambaDecoderLayer
}
...
class SambaForCausalLM(nn.Module, HasInnerState):
    ...
    def load_weights(self, weights: Iterable[Tuple[str, torch.Tensor]]):
        ...
        for name, loaded_weight in weights:
            ...
            #     name = name.replace("mlp", "mlp.experts.0")
